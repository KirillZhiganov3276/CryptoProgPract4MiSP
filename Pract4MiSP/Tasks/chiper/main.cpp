...
int main() {
    ...
    if (mode == "encrypt") {
        ...
        ofstream user_password_file("/home/stud/Pract4MiSP/Tasks/chiper/user_password_file.txt");
        ...
        string user_pass;
        FileSource("/home/stud/Pract4MiSP/Tasks/chiper/user_password_file.txt", true, new StringSink(user_pass));
        if (pass != user_pass) {
